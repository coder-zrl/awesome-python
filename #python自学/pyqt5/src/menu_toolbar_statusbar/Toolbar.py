...
class Toolbar(QMainWindow) :
    ...
    def initUI(self):
        ...
        new = QAction(QIcon('../../5、菜单栏、工具栏、状态栏/images/new.png'), "new", self)
        tb1.addAction(new)

        open = QAction(QIcon('../../5、菜单栏、工具栏、状态栏/images/open.png'), "open", self)
        tb1.addAction(open)

        save = QAction(QIcon('../../5、菜单栏、工具栏、状态栏/images/save.png'), "save", self)
        tb1.addAction(save)


        tb2 = self.addToolBar("File1")
        new1 = QAction(QIcon('../../5、菜单栏、工具栏、状态栏/images/new.png'), "新建", self)
        tb2.addAction(new1)
