...
class QSliderDemo(QWidget):
    ...
    def initUI(self):
        ...
        self.label.setAlignment(Qt.AlignCenter)  # 设置居中显示

        layout.addWidget(self.label)

        self.slider = QSlider(Qt.Horizontal)  # 设置成水平的
        ...
        self.slider.valueChanged.connect(self.valueChange)  # 设置接口




        self.slider1 = QSlider(Qt.Vertical)  # 设置成垂直的
