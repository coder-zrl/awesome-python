...
# sendemail.send_text('3181314768@qq.com','正文啥也不想写','主题：测试发送文本')
sendemail.send_img('3181314768@qq.com','正文啥也不想写','主题：测试','img.jpg')
# sendemail.send_file('1655412661@qq.com','来自外太空的邮件','主题：测试发送文件','text.txt','text.txt')
